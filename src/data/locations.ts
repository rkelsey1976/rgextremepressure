...
export const locationsDatabase: LocationData[] = [
...

  {
    ...
    county: 'Somerset',
    group: 'town',
    metaTitle: 'Builders & Property Maintenance Batheaston',
...

  {
    ...
    county: 'Somerset',
    group: 'town',
    metaTitle: 'Builders in Bathford | Stone Cottage & Hillside Specialists',
...

  {
    ...
    county: 'Somerset',
    group: 'town',
    metaTitle: 'Builders in Bathampton | Canalside & Riverside Specialists',
...

  {
    ...
    county: 'Wiltshire',
    group: 'town',
    metaTitle: 'Builders in Box | Period Property & Stone Specialists',
  ...
  // ── Charming Small Towns & Commuters ──
  {
    ...
    county: 'Wiltshire',
    group: 'town',
    metaTitle: 'Builders in Bradford on Avon | Heritage & Lime Specialists',
    ...
    heroHeading: 'Builders & Heritage Specialists in Bradford on Avon',
...

  {
    ...
    county: 'Wiltshire',
    group: 'town',
    metaTitle: 'Builders in Corsham | Stone & Cottage Specialists',
...

  {
    ...
    county: 'Somerset',
    group: 'town',
    metaTitle: 'Builders in Keynsham & Saltford | Extensions & Conversions',
    ...
    heroHeading: 'Builders & Extension Specialists in Keynsham & Saltford',
  ...
  // ── Vibrant Market Towns & Suburbs ──
  {
    ...
    county: 'Wiltshire',
    group: 'market',
    metaTitle: 'Builders in Chippenham | Home Extensions & Modernization',
    ...
    heroHeading: 'Builders & Modernization Specialists in Chippenham',
...

  {
    ...
    county: 'Somerset',
    group: 'market',
    metaTitle: 'Builders in Frome & Radstock | Renovation & Garden Specialists',
