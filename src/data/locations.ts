...
export const locationsDatabase: LocationData[] = [
...

  {
    ...
    county: 'Somerset',
    group: 'town',
    metaTitle: 'Stone Cottage Builders Bathford',
...

  {
    ...
    county: 'Somerset',
    group: 'town',
    metaTitle: 'Canalside Home Repairs Bathampton',
  ...
  // ── Charming Small Towns & Commuters ──
  {
    ...
    county: 'Wiltshire',
    group: 'town',
    metaTitle: 'Heritage Builders Bradford on Avon',
...

  {
    ...
    county: 'Wiltshire',
    group: 'town',
    metaTitle: 'Stone Masonry & Cottage Updates Corsham',
...

  {
    ...
    county: 'Somerset',
    group: 'town',
    metaTitle: 'Extension & Conversion Specialists Keynsham',
  ...
  // ── Vibrant Market Towns & Suburbs ──
  {
    ...
    county: 'Wiltshire',
    group: 'market',
    metaTitle: 'Home Extensions & Modernization Chippenham',
...

  {
    ...
    county: 'Somerset',
    group: 'market',
    metaTitle: 'Renovation & Sloped Garden Specialists Frome',
