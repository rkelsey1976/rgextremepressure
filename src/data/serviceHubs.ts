...
export const serviceHubs: ServiceHub[] = [
  // ── Driveway Cleaning ──
  {
    ...
    metaDescription: 'Driveway cleaning across Bath, Bristol and Somerset. Block paving, tarmac, concrete and resin jet washed, re-sanded and sealed. Rated 5.0 from 113 Google reviews. Call 07474 939 398.',
  ...
  // ── Patio Cleaning ──
  {
    ...
    metaDescription: 'Patio cleaning across Bath, Bristol and Somerset. Indian sandstone, porcelain, slate and concrete — algae, moss and black spot removed safely. Rated 5.0 from 113 Google reviews.',
    heroEyebrow: 'Bath · Bristol · Somerset',
  ...
  // ── Roof Cleaning ──
  {
    ...
    metaDescription: 'Roof cleaning and moss removal across Bath, Bristol and Somerset. Spinning brush system cleans tiles from ground level — no walking on your roof. Rated 5.0 from 113 Google reviews.',
    heroEyebrow: 'Bath · Bristol · Somerset',
  ...
  // ── Gutter Cleaning ──
  {
    ...
    metaDescription: 'Gutter cleaning across Bath, Bristol and Somerset. Full gutter clear, downpipe flush and minor repair from ground level. Rated 5.0 from 113 Google reviews. Call 07474 939 398.',
    heroEyebrow: 'Bath · Bristol · Somerset',
  ...
  // ── Render Cleaning ──
  {
    ...
    metaDescription: 'Soft wash render cleaning across Bath, Bristol and Somerset. K-Rend, silicone and painted render cleaned without high pressure. Rated 5.0 from 113 Google reviews. Call 07474 939 398.',
    heroEyebrow: 'Bath · Bristol · Somerset',
